    ...
    if response.status_code == 200:
        ...
        for record in records:
            ...
            st.session_state["history_chats"].append(
                {"id": chat_id, "messages": messages, "pdf_name": pdf_name, "pdf_path": pdf_path, "pdf_uuid": pdf_uuid})
...
def create_chat_with_pdf(chat_name, uploaded_pdf):
    with st.spinner("Uploading and Processing document, please wait..."):
        ...
        if response.status_code == 200:
            ...
            new_chat = {"id": new_chat_id, "messages": [], "pdf_name": uploaded_pdf.name, "pdf_path": pdf_path,
                        "pdf_uuid": pdf_uuid}
    ...
    if current_chat:
        ...
        if prompt := st.chat_input("Your Message:"):
            ...
            with st.chat_message("assistant"):
                ...
                save_chat_to_db(chat_id, chat_name, current_chat["messages"], current_chat["pdf_name"],
                                current_chat["pdf_path"], current_chat["pdf_uuid"])
else:
